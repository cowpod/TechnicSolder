...
class Db {
	...
	public function test() {
		...
		try {
		    ...
		    error_log("Connection test failed: ".$e);
		    return false;
		}
	...
	public function test($host, $user, $pass, $name) {
		// pure
		$testconn;
		try {
	...
	public function query($querystring) {
		...
		try {
		    ...
		    error_log("SQL query exception: ".$e);
		...
		if (!$result) {
		    ...
		    error_log("SQL query error: ".mysqli_error($result));
		    if ($one_time_connection) $this->disconnect();
		    return [];
		}
